...
2. **Note Management**：Supports retrieving note properties, displaying summaries of note updates/creations, and automatically refreshing the notes list.
...
- **Default Date Format**：Supports customizing the default title format for daily notes, such as YYYY-MM-DD, YYYY/MM/DD, etc.

### Note Creation Settings
- **Default Folder**：You can set the default folder path for note creation.

## Usage

### Basic Operations
1. **Switch Views**：Click the buttons at the top of the calendar to switch between monthly and yearly views.

2. **Navigate Dates**：Use the arrow buttons at the top of the calendar to navigate to the previous or next month/year.

3. **View Notes**：Click on a date in the calendar to view the notes list for that day.
