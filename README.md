...
### v1.4.2 — 修复问题（2026-09-24）
- 移除设置页顶部的插件名标题（Obsidian 设置页已自带插件名显示）
- 设置页标题与内联样式遵循 Obsidian 官方 DOM API 规范

### v1.4.1 — 笔记缓存架构优化（2026-09-24）
- 笔记缓存提升至插件级共享：多个日历视图共用同一份数据，切换/重建视图不再重复扫描
- 日历未打开时，笔记的创建、修改、重命名、删除同样实时更新缓存，打开即显示最新状态
