...
1. **安装插件**：将插件压缩包obsidian-floating-settings.zip解压到Obsidian的插件目录中，重启Obsidian。

2. **启用插件**：在Obsidian中打开设置，找到插件列表，启用"Note Calendar"插件。

3. **配置插件**：根据需要配置日期格式、默认文件夹等设置。

4. **使用插件**：在Obsidian中打开日历视图，即可开始使用插件的功能。
